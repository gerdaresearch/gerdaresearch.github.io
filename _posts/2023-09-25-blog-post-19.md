...
花束選択時の重要度は、スタイル＞日持ち ＞ アップサイクル ＞サイズ の順（コンジョイント分析）。アップサイクルや小さめサイズは、花束の魅力度アップにある程度貢献する。  
※実施概要はページ下部に掲載。  
...
Style > Vase life > Upcycling > Size.  Both upcycling and smaller sizes contribute to enhancing the attractiveness of flower bouquets.
